...
<body>
                ...
                <div class="row g-4 justify-content-center">
                    <div class="col-lg-12">
                        <div class="banner__content center">
                            ...
                            <h1 class="wow fadeInDown" data-wow-duration="4s">Yessenia & Víctor</h1>
                ...
                <div class="about__wrapper__one  owl-theme owl-carousel">
                    <div class="about__items">
                        <div class="about__thumb">
                            <img src="assets/img/about/about1.jpg" alt="about__image" style="height: 50%;">
                    ...
                    <div class="about__items">
                        <div class="about__thumb">
                            <img src="assets/img/about/about2.jpg" alt="about__image" style="height: 50%;">
                            <div class="about__effect">
                    ...
                    <div class="about__items">
                        <div class="about__thumb">
                            <img src="assets/img/about/about3.jpg" alt="about__image" style="height: 50%;">
                            <div class="about__effect">
    ...
    <section class="love__section pt-120 pb-120">
        <div class="container">
            <div class="section__header section__center wow fadeInDown" data-wow-duration="4s">
                ...
                <img src="assets/img/tittle/flower.png" alt="flower__tittle" style="height: 15%;">
            </div>
            <div class="row g-0">
                <div class="col-xxl-6 col-xl-6 col-lg-6">
    ...
    <section class="member__wedding__section pb-120">
        <div class="shape__one">
            <img src="assets/img/member/left-shape.png" alt="left__shape" style="height: 40%;">
        </div>
        <div class="member__section pt-120 pb-120">
            <div class="left__shape">
                <img src="assets/img/member/shape.png" alt="shape__image" style="height: 40%;">
            </div>
            <div class="member__wrapper owl-theme owl-carousel">
                <div class="member__thumb">
                    <img src="assets/img/member/member1.png" alt="member__image" style="height: 40%;">
                </div>
                <div class="member__thumb">
                    <img src="assets/img/member/member2.png" alt="member__image" style="height: 40%;">
                </div>
                <div class="member__thumb">
                    <img src="assets/img/member/member3.png" alt="member__image" style="height: 40%;">
                </div>
                <div class="member__thumb">
                    <img src="assets/img/member/member4.png" alt="member__image" style="height: 40%;">
                </div>
                <div class="member__thumb">
                    <img src="assets/img/member/member5.png" alt="member__image" style="height: 40%;">
                </div>
            </div>
        </div>
            ...
            <div class="row g-4">
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 wow fadeInDown" data-wow-duration="7s">
                    <div class="blog__items">
                        ...
                        <div class="blog__content">
                            <h4>
                                <a href="index.php?wedding=blog-single">top 10 gifts</a>
                            </h4>
                            <p>
                            ...
                            <div class="blog-button mt-2">
                                <a href="index.php?wedding=blog-single" class="blog-btn">read more</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 wow fadeInUp" data-wow-duration="5s">
                    <div class="blog__items">
                        ...
                        <div class="blog__content">
                            <h4>
                                <a href="index.php?wedding=blog-single">Best Photography Idea</a>
                            </h4>
                            <p>
                                The tradition is based on an Old English rhyme that dates back to 19th-century Lancashire.It describes the items a bride should have on her wedding day.
                            </p>
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 wow fadeInDown" data-wow-duration="2s">
                    <div class="blog__items">
                        ...
                        <div class="blog__content">
                            <h4>
                                <a href="index.php?wedding=blog-single">Wedding Flower Collect</a>
                            </h4>
                            <p>
                                The tradition is based on an Old English rhyme that dates back to 19th-century Lancashire.It describes the items a bride should have on her wedding day.
                            </p>
